...
Coho rearing/spawning network upstream of the Neexdzii Kwa / Wedzin Kwa
confluence with watershed AOI, all FWA streams, lakes, and wetlands.
Colours from the [gq](https://github.com/NewGraphEnvironment/gq) style
registry.
...
confluence (order 4+), with all FWA streams, lakes, and
wetlands.](figure/plot-co-habitat-1.png)

Coho rearing and spawning habitat upstream of the Neexdzii Kwa
confluence (order 4+), with all FWA streams, lakes, and wetlands.

1027 coho habitat segments (orders 4, 5, 6), 8876 total stream segments,
363 lakes, 1293 wetlands.

## Summary

| Function                                                                                                                                                                                      | What it does                                                   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| [`frs_point_snap()`](https://newgraphenvironment.github.io/fresh/reference/frs_point_snap.md)                                                                                                 | Snap a point to the nearest stream                             |
| [`frs_stream_fetch()`](https://newgraphenvironment.github.io/fresh/reference/frs_stream_fetch.md)                                                                                             | Fetch FWA streams by watershed group, bbox, or blue line key   |
| [`frs_network_upstream()`](https://newgraphenvironment.github.io/fresh/reference/frs_network_upstream.md) / `_downstream()`                                                                   | Walk the stream network                                        |
| [`frs_network_prune()`](https://newgraphenvironment.github.io/fresh/reference/frs_network_prune.md)                                                                                           | Filter by order, gradient, or custom SQL predicates            |
| [`frs_waterbody_network()`](https://newgraphenvironment.github.io/fresh/reference/frs_waterbody_network.md)                                                                                   | Lakes/wetlands upstream or downstream via waterbody_key bridge |
...
All functions accept `table` and `cols` parameters for flexibility
across FWA and bcfishpass views.
