...
2133 coho habitat segments with rearing or spawning (orders
1, 2, 3, 4, 5, 6).
...
See the [function reference](https://newgraphenvironment.github.io/fresh/reference/) for the full API.
